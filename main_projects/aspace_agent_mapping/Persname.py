...
class Persname:
    ...
    def reduce_dict(self, data_dict):
        aspace_dict = {}
        keys = [u"primary_name", u"title", u"name_order", u"prefix", u"rest_of_name", u"suffix", u"fuller_form", u"number"]
    ...
    def create_aspace_dates(self, data_dict):
        expression = data_dict["date_string"]
        birthdate = data_dict["birth_date"]
        deathdate = data_dict["death_date"]
